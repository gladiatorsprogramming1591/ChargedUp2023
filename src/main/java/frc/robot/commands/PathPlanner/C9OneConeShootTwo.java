...
public class C9OneConeShootTwo extends SequentialCommandGroup {

    public C9OneConeShootTwo(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_secondPath = PathPlanner.loadPath("Full Drive to Shoot 9", 
