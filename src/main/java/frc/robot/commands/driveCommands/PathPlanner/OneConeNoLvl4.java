...
public class OneConeNoLvl4 extends SequentialCommandGroup {

    public OneConeNoLvl4(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 4",
            new PathConstraints(2, 3));
