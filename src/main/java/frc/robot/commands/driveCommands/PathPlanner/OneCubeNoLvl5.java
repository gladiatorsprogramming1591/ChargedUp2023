...
public class OneCubeNoLvl5 extends SequentialCommandGroup {

    public OneCubeNoLvl5(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 5", 
            new PathConstraints(2, 3));
