...
public class OneConeNoLvl3 extends SequentialCommandGroup {

    public OneConeNoLvl3(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 3",
            new PathConstraints(2, 3));
