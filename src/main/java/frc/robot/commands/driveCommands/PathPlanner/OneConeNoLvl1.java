...
public class OneConeNoLvl1 extends SequentialCommandGroup {

    public OneConeNoLvl1(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 1",
            new PathConstraints(2, 3));
