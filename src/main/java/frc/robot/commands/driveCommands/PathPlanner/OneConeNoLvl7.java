...
public class OneConeNoLvl7 extends SequentialCommandGroup {

    public OneConeNoLvl7 (DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 7",
            new PathConstraints(2, 3));
