...
public class OneConeNoLvl6 extends SequentialCommandGroup {

    public OneConeNoLvl6(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 6",
            new PathConstraints(2, 3));
