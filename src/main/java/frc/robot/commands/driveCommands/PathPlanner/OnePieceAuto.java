...
public class OnePieceAuto extends SequentialCommandGroup {
    ...
    public OnePieceAuto(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_firstPath = PathPlanner.loadPath("Cone Score 1", 
            ...
            PathPlannerTrajectory m_secondPath = PathPlanner.loadPath("Cone Score Reverse", 
        ...
        addCommands(
            new InstantCommand(() -> intakeSubsystem.intakeOn(Constants.IntakeConstants.kIntakeMaxOutput),intakeSubsystem),
            ...
            new InstantCommand(() -> intakeSubsystem.intakeOn(Constants.IntakeConstants.kIntakeMinOutput), intakeSubsystem),
