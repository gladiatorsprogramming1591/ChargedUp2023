...
public class OneConeNoLvl9 extends SequentialCommandGroup {

    public OneConeNoLvl9(DriveSubsystem driveSubsystem, 
        ...
        PathPlannerTrajectory m_thirdPath = PathPlanner.loadPath("Only Leave Community 9",
            new PathConstraints(2, 3));
