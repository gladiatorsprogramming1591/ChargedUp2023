...
//   XboxController m_driverController = new XboxController(OIConstants.kDriverControllerPort);
  ...
  private void addAutoOptions() {
    ...
    m_autoChooser.addOption("C1 ThreePiece", new C1ThreePiece(PathConstants.LVL, false, m_robotDrive, m_arm, m_intake, m_LEDs, m_groundJoint)); // TODO: NEEDS WORK
    m_autoChooser.addOption("C1 ThreePiece NO LVL", new C1ThreePiece(PathConstants.NoLVL, false, m_robotDrive, m_arm, m_intake, m_LEDs, m_groundJoint));
